...
function xyz_fbap_addpostmetatags()
{
    ...
    <table class="xyz_fbap_meta_acclist_table"><!-- FB META -->
        ...
        <tr valign="top">
            <td class="xyz_fbap_pleft15" width="40%">Enable auto publish post to my facebook account
            </td>
            <td width="60%" class="small">
                <select id="xyz_fbap_post_permission" name="xyz_fbap_post_permission"
                        onchange="displaycheck_fbap()">

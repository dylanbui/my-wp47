...
class Shortcode
{
    ...
    public function __construct() {
        $this->view = new View(__TEMPLATES_HTML_PATH.'/includes/templates/shortcode');
    }
    ...
    {
        return $this->view->fetch('answerForm');
    }
    ...
    public function displayGooglemap($args, $content)
    {
        ...
        return $this->view->fetch('displayGooglemap', array("args" => $args));
    }
    ...
    function displayYoutube( $attr )
    {
        ...
        if ( !empty( $id ) ) {
            ...
            $iframe = $this->view->fetch('displayYoutube', array("args" => $args));
        }

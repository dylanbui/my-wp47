...
function bst_enqueues() {
	...
	wp_enqueue_style('bootstrap-css');
  	...
  	wp_register_style('bst-css', get_template_directory_uri() . '/assets/css/bst.css', false, null);
	...
	wp_register_script('bst-js', get_template_directory_uri() . '/js/assets/bst.js', false, null, true);

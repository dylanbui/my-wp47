...
//require_once( WP_PLUGIN_DIR . '/tax-meta-class/tax-meta-class.php');
...
//			'pages' => array('category', 'main-categories'),        // taxonomy name, accept categories, post_tag and custom taxonomies
...
//
//	//text field
//	$my_meta->addText($prefix.'order',array('name'=> __('Order ','tax-meta'),'desc' => 'Order field desription'));
//	//textarea field
...
//// 	//Image field
//// 	$my_meta->addImage($prefix.'image_field_id',array('name'=> __('My Image ','tax-meta'),'desc' => 'thu hang moi biet'));
//// 	//file upload field
//// 	$my_meta->addFile($prefix.'file_field_id',array('name'=> __('My File ','tax-meta')));
//
//	//wysiwyg field
//// 	$my_meta->addWysiwyg($prefix.'wysiwyg_field_id',array('name'=> __('My wysiwyg Editor ','tax-meta'), 'style' =>'width: 250px; height: 200px'));
//	//taxonomy field
